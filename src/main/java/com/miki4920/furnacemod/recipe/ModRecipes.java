...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<LiquidMachineRecipe>> LAVA_POWERED_FURNACE_SERIALIZER =
            SERIALIZERS.register("lava_powered_furnace_recipe", () -> LiquidMachineRecipe.Serializer.INSTANCE);
