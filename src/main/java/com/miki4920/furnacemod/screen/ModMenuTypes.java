...
public class ModMenuTypes {
    ...
    public static final RegistryObject<MenuType<LiquidMachineMenu>> LAVA_POWERED_FURNACE_MENU = registerMenuType(LiquidMachineMenu::new, "lava_powered_station_menu");
