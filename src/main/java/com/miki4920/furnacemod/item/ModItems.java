...
public class ModItems {
    ...
    public static final RegistryObject<Item> OBSIDIAN_INGOT_SWORD = ITEMS.register("obsidian_ingot_sword",
            () -> new SwordItem(ModTiers.OBSIDIAN_INGOT, 6, -2.4f, new Item.Properties().fireResistant().tab(ModCreativeModeTab.FURNACE_MOD_TAB)));

    public static final RegistryObject<Item> OBSIDIAN_INGOT_PICKAXE = ITEMS.register("obsidian_ingot_pickaxe",
            () -> new PickaxeItem(ModTiers.OBSIDIAN_INGOT, -1, -2.4f, new Item.Properties().fireResistant().tab(ModCreativeModeTab.FURNACE_MOD_TAB)));

    public static final RegistryObject<Item> OBSIDIAN_INGOT_AXE = ITEMS.register("obsidian_ingot_axe",
            () -> new AxeItem(ModTiers.OBSIDIAN_INGOT, 6, -3.2f, new Item.Properties().fireResistant().tab(ModCreativeModeTab.FURNACE_MOD_TAB)));

    public static final RegistryObject<Item> OBSIDIAN_INGOT_HOE = ITEMS.register("obsidian_ingot_hoe",
            () -> new HoeItem(ModTiers.OBSIDIAN_INGOT, -1, -2.4f, new Item.Properties().fireResistant().tab(ModCreativeModeTab.FURNACE_MOD_TAB)));

    public static final RegistryObject<Item> OBSIDIAN_INGOT_SHOVEL = ITEMS.register("obsidian_ingot_shovel",
            () -> new ShovelItem(ModTiers.OBSIDIAN_INGOT, -1, -2.4f, new Item.Properties().fireResistant().tab(ModCreativeModeTab.FURNACE_MOD_TAB)));
